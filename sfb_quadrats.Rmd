...
```{r fucus x zone, fig.cap = " Cover of *Fucus distichus* at survey sites in the mid and low intertidal zones. Paradise Beach Park and Point Molate had sandy/muddy habitat in the low zone and thus were not surveyed. Width of the box plot appears wider at these sites than the others"}
...
```{r fucus mid, fig.cap = " Cover of *Fucus distichus* in mid intertidal zone at survey sites. Green fill indicates reference sites used for nature-based restoration and climate adaptation planning at the SF State Romberg Tiburon Campus"}
...
```{r fucus low, fig.cap = " Cover of *Fucus distichus* in low intertidal zone at survey sites. Green fill indicates reference sites used for nature-based restoration and climate adaptation planning at the SF State Romberg Tiburon Campus. Paradise Beach Park and Point Molate had sandy/muddy habitat in the low zone and thus were not surveyed."}
...
fucus_p3 
```
```{r fucus mid sitetype, fig.cap = " Mid zone rockweed cover by site type (cobble, bench, riprap)"}

#Mid zone Fucus cover x sitetype
fucus_p4 <- rqs5 %>% 
  filter(site_type != "blocks") %>%
    filter(site_type != "seawall") %>%
 # filter(site_code != "RTCS")%>%
  #  filter(site_code != "PBS")%>%
...
fucus_p4 
```
```{r fucus low sitetype, fig.cap = " Low zone rockweed cover by site type (cobble, bench, riprap)"}
...
```{r ostrea x zone, fig.cap = " Cover of *Ostrea lurida* at survey sites in the mid and low intertidal zones. Paradise Beach Park and Point Molate had sandy/muddy habitat in the low zone and thus were not surveyed. Width of the box plot appears wider at these sites than the others"}
...
```{r ostrea mid, fig.cap = " Abundancer of *Ostrea lurida* in mid intertidal zone at survey sites. Coral fill indicates reference sites used for nature-based restoration and climate adaptation planning at the SF State Romberg Tiburon Campus."}
...
```{r ostrea low, fig.cap = " Abundancer of *Ostrea lurida* in low intertidal zone at survey sites. Coral fill indicates reference sites used for nature-based restoration and climate adaptation planning at the SF State Romberg Tiburon Campus.Paradise Beach Park and Point Molate had sandy/muddy habitat in the low zone and thus were not surveyed."}
...
```{r ostrea mid sitetype, fig.cap = " Mid zone oyster abundance by site type (cobble, bench, riprap)"}
...
```{r ostrea low sitetype, fig.cap = " Low zone oyster abundance by site type (cobble, bench, riprap)"}
