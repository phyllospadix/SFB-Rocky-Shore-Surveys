...
my_packages <- c("renv", "easypackages",  "here", "ggthemes", "gridExtra", "tidyverse", "lubridate", "patchwork", "tinytex", "bookdown", "ggpubr", "wesanderson", "pals", "ggridges", "hrbrthemes", "virdis") 
...
oysters2 <-oysters %>%
  mutate(site_name = fct_reorder(site_name, size_mm))
# add dummy variable to plot site in ridge plot
oysters2 <- oysters2 %>% add_row(site_name = "SF Marina", size_mm = 10)
oysters2 <- oysters2 %>% add_row(site_name = "Horseshoe Bay", size_mm = 10)
...
```{r Fig.6, fig.width = 10, fig.height = 10, fig.cap = " Size structure of oysters, bay mussels and limpets in mid and low intertidal at study sites."}
