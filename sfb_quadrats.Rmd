...
fucus_p2 +labs(x = NULL,  y = expression(paste(italic(" Fucus distichus"), " cover (%)")))
...
fucus_p3 +labs(x = NULL,  y = expression(paste(italic(" Fucus distichus"), " cover (%)")))
```
...
oysters_p2 +labs(x = NULL,  y = expression(paste(italic("Ostrea lurida "), "abundance ", " (no. ",  m^-2,")")))
...
oysters_p3 +labs(x = NULL,  y = expression(paste(italic("Ostrea lurida "), "abundance ", " (no. ",  m^-2,")")))
```
```{r}
